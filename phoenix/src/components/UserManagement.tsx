    ...
    <section className="container px-4 mx-auto">
      ...
      <div className="mt-4">
        <input
          ...
          className="w-full px-4 py-2 border bg-gray-800 rounded-md border-gray-800 focus:outline-none dark:text-white"
        />
      </div>
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-800">
                  <tr>
                    ...
                    <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Options</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                  {filteredUsers.map((user) => (
                    <tr key={user.id}>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">25</td>
                      <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">12</td>
