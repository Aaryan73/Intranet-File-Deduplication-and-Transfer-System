...
const Popup = () => {
  ...
  return (
    <div className="flex flex-col pb-10 h-full w-full items-center justify-center gap-4">
      <h1 className="text-center py-4 text-lg">Recent Downloads</h1>
